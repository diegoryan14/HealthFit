...
import static com.mycompany.myapp.domain.DietaAsserts.*;
...
class DietaResourceIT {
    ...
    void partialUpdateDietaWithPatch() throws Exception {
        ...
        partialUpdatedDieta.descricaoRefeicao(UPDATED_DESCRICAO_REFEICAO).dataHorarioRefeicao(UPDATED_DATA_HORARIO_REFEICAO);
