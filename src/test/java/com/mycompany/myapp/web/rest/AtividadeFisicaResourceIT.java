...
import static com.mycompany.myapp.domain.AtividadeFisicaAsserts.*;
...
import com.mycompany.myapp.domain.enumeration.TipoAtividade;
...
class AtividadeFisicaResourceIT {
    ...
    void partialUpdateAtividadeFisicaWithPatch() throws Exception {
        ...
        partialUpdatedAtividadeFisica.duracao(UPDATED_DURACAO);
