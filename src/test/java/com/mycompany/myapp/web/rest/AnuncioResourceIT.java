...
import static com.mycompany.myapp.domain.AnuncioAsserts.*;
...
class AnuncioResourceIT {
    ...
    void putExistingAnuncio() throws Exception {
        ...
        updatedAnuncio.titulo(UPDATED_TITULO).descricao(UPDATED_DESCRICAO).dataPublicacao(UPDATED_DATA_PUBLICACAO).preco(UPDATED_PRECO);
    ...
    void partialUpdateAnuncioWithPatch() throws Exception {
        ...
        partialUpdatedAnuncio.titulo(UPDATED_TITULO);
